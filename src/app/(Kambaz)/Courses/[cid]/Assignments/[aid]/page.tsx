    ...
    return (
      <div id="wd-assignments-editor">
        ...
        <textarea id="wd-description">
          ...
          name and section Links to each of the lab assignments Links to the Kanzas application
          Links to all relevant source code repositories The Kanzas application should include a link
