...
export default function Lab1() {
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                <h4>Heading Tags</h4>
                Text documents are often broken up into several sections and subsections. Each section is usually prefaced with a short title or heading that attempts to summarize the topic of the section it precedes. For instance this paragraph is preceded by the heading Heading Tags. The HTML heading tags can be used to format plain text so that it renders in a browser as a heading. There are 6 heading tags: h1, h2, h3, h4, h5, and h6. Tag h1 is the most important heading and h6 is the least important. More important headings are rendered larger and more prominent by default.
            </div>
            <div id="wd-p-tag">
                <h4>Paragraph Tag</h4>
                <p id="wd-p-1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Whisk the eggs with a fork until blended.</li>
                    <li>Pour the eggs into a hot, buttered skillet.</li>
                    <li>Stir gently until cooked to your liking.</li>
                </ol>
            ...
            <div id="wd-anchor-tag">
                ...
                My GitHub repository is <a href="https://github.com/DaanielPan" id="wd-github">here</a>.<br />
            </div>
